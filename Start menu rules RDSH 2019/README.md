...
If you want to use other groups then Domain Users and Domain Admins, you have to customize the script. The script can be used in several languages, which is important  because the system accounts have different names. In German, for example, the name for the local service is "LOKALER DIENST".
